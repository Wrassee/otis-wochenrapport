...
import { Calendar, FileSpreadsheet, Info, Paperclip, X, ChevronLeft, ChevronRight } from 'lucide-react'
        ...
        <div className="grid grid-cols-4 gap-2">
          {photos.map((photo, idx) => (
            <button
              ...
              className="relative w-full aspect-square rounded-lg overflow-hidden border border-otis-200/20 dark:border-white/10 bg-otis-100/30 dark:bg-otis-900/30 p-0 min-h-0 transition-transform active:scale-95"
