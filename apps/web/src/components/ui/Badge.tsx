...
const variants = {
  default: 'bg-white/50 text-gray-700 dark:bg-white/10 dark:text-gray-200 border border-otis-200/30 dark:border-white/10',
  success: 'bg-emerald-50/80 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300 border border-emerald-200/50',
  warning: 'bg-amber-50/80 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300 border border-amber-200/50',
